                    ...
                    <div class="panel mb-3">
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-6">
                                ...
                                @else
                                    <div class="form-control-plaintext small-muted">{{ $user->name }}</div>
                                @endif
                            </div>
                            ...
                            @else
                                <div class="col-md-6">
                                    <label class="form-label">{{ __('messages.users.role') ?? 'Role' }}</label>
                                    <div class="form-control-plaintext small-muted">{{ $user->role?->name ?? '—' }}</div>
                                </div>
                            @endif
                            ...
                            <div class="col-md-6">
                                ...
                                @else
                                    <div class="form-control-plaintext small-muted">{{ $user->email ?? '—' }}</div>
                                @endif
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control-plaintext small-muted">{{ $user->telegram_id ?? '—' }}</div>
                            </div>
                        ...
                        @else
                            <div class="mt-3 text-end">
                                <small class="text-muted">{{ __('messages.users.read_only') ?? 'Read-only' }}</small>
                            </div>
                        @endif
