    ...
    <div class="col-md-6">
      <div class="card p-4 auth-box">
        ...
        <div id="stepPhone">
          ...
          <input type="hidden" name="department" id="departmentHidden" value="{{ $department->id }}">
...
(function(){
  ...
  document.getElementById('btnPhone').addEventListener('click', function(){
    ...
    formData.append('department', document.getElementById('departmentHidden')?.value || '{{ $department->id }}');
    ...
    .then(data => {
      if (data.status === 'sms_sent' || data.status === 'sent') {
        ...
        document.getElementById('departmentHidden').value = '{{ $department->id }}';
